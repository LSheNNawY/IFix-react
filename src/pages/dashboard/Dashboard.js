...
const StatisticsTotal = async () => {
  return await axios.get(
      `${process.env.REACT_APP_API_URL}/statisticstotal`
  );
};
                ...
                <Row>
                  <Col xs="5">
                    <div className="icon-big text-center icon-warning">
                      <i className="fas fa-users" style={{color: "#FF9500"}}></i>
                    </div>
                  </Col>
                  <Col xs="7">
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  <Col xs="5">
                    <div className="icon-big text-center icon-warning">
                      <i className="fas fa-user-secret" style={{color: "#87CB16"}}></i>
                    </div>
                  </Col>
                  <Col xs="7">
                    <div className="numbers">
            ...
            <Card className="card-stats">
              <Card.Body>
                <Row>
                  <Col xs="5">
                    <div className="icon-big text-center icon-warning">
                      <i className="fas fa-briefcase" style={{color: "#FF4A55"}}></i>
                    </div>
                  </Col>
                  <Col xs="7">
                    <div className="numbers">
                ...
                <Row>
                  ...
                  <Col xs="7">
                    <div className="numbers">
                      ...
                      <Card.Title as="h4">{employeeCountTotalRecent}</Card.Title>
                    </div>
                  </Col>
                </Row>
              </Card.Body>
