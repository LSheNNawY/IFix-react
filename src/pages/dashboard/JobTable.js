                ...
                <Table className="table-hover table-striped">
                  <thead>
                    <tr>
                      ...
                      <th className="border-0"> Employee_Phone </th>
                      <th className="border-0"> Client_Name </th>
                      <th className="border-0"> Client_Phone </th>
                      <th className="border-0"> Profession </th>
                      <th className="border-0"> Service_Title </th>
                      <th className="border-0"> Service_Price </th>
                          ...
                          <tr key={index}>
                            ...
                            <td>
                              {job.profession.services.length > 0 ? (
                                job.profession.services.map((service, i) => {
                                  return (
                                    <p>{job.profession.services[i].service}</p>
                                  );
                                })
                              ) : (
                                <></>
                            ...
                            <td>
                              {job.profession.services.length > 0 ? (
                                job.profession.services.map((service, i) => {
                                  return (
                                    <p> {job.profession.services[i].price}</p>
                                  );
                                })
                              ) : (
                                <></>
