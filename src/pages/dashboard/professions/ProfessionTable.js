...
function ProfessionTable({ professionState, setProfessions,index ,setRefresh}) {
  ...
  <>
    <EditProfession setRefresh={setRefresh} profession={profession} setProfession={setProfession} show={modalShow} onHide={() => setModalShow(false)} />
