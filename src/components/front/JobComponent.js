...
export default function JobComponent({ job }) {
  ...
  const handleSubmitEndDate = (e) => {
    axios
      .put(`${process.env.REACT_APP_API_URL}/jobs/${empJob._id}/updateEnded`, {
        ended_at: endDate,
      })
      .then(({ data }) => {
        if (data.ok) {
  ...
  const handleSubmitPrice = (e) => {
    axios
      .put(`${process.env.REACT_APP_API_URL}/jobs/${empJob._id}/updatePrice`, {
        price,
      })
      .then(({ data }) => {
        if (data.ok) {
    ...
    <div className="services__item">
      ...
      >
        ...
        <Modal.Footer className="mt-4">
          ...
          <Button variant="primary" onClick={(e) => handleSubmitStartDate(e)}>
            Start
          </Button>
        </Modal.Footer>
      </Modal>
      ...
      >
        ...
        <Modal.Footer className="mt-4">
          ...
          <Button variant="primary" onClick={(e) => handleSubmitEndDate(e)}>
            End
          </Button>
        </Modal.Footer>
      </Modal>
        ...
        <div className="row job_container">
          ...
          <div className="col-9">
            ...
            <div className="dates">
                  ...
                  <h4>
                    ...
                    <h6>
                      {empJob.started_at ? (
                        ...
                        <div>
                          <i className="badge badge-warning h6">Pending</i>
                          <span
              ...
              <div className="row ">
                <div className="col-6 ">
                  <span className="h4 d-block my-1">Client Name :</span>
              ...
              <div className="row ">
                <div className="col-6">
                  <div className="mb-3">
                    ...
                    <i
                      className={`${
                        empJob.ended_at ? "h6 badge badge-success" : "h6"
                      }`}
                    >
                      {empJob.price} EGP
                    </i>
