    ...
    <div className="index-wrapper">
      <div className="container-fluid">
        ...
        >
              ...
              <div className="col-lg-6">
                <div className="row">
                  <div className="col-md-12">
                    <img src={ifix2} alt="img" height="100%" />
                  </div>
                  <div className="col-md-12">
                    <img
                      src={ifix3}
          ...
          <div className="col-lg-6 about__text" style={{ paddingLeft: "50px" }}>
            ...
            <p>
              We want you to be happy with your repair or installation, and
              that's why we offer a 100% satisfaction guarantee. If you aren't
              happy, we'll keep working until you are.
            </p>
